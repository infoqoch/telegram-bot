...
class TelegramUpdateTest {
    ...
    void update_list() throws IOException {
        String target = "{\"ok\":true,\"result\":[{\"update_id\":567841804,\n" +
                ...
                "listResponse = Response(ok=true, result=[Update(updateId=567841804, message=Message(messageId=2102, date=2022-05-08T16:03:11Z, text=hi, from=From(id=YOUR_CHAT_ID, isBot=false, firstName=석진, username=null, languageCode=ko), chat=Chat(id=YOUR_CHAT_ID, type=private, firstName=석진)), editedMessage=null)])";
