...
class TelegramUpdateTest {
    ...
    void update_plain_chat_message() throws IOException {
        String json = "{\"ok\": true,\"result\": [{\"update_id\": 567841806,\"message\": {\"message_id\": 2148,\"from\": {\"id\": YOUR_CHAT_ID,\"is_bot\": false,\"first_name\": \"\\uc11d\\uc9c4\",\"language_code\": \"ko\"},\"chat\": {\"id\": YOUR_CHAT_ID,\"first_name\": \"\\uc11d\\uc9c4\",\"type\": \"private\"},\"date\": 1653482374,\"text\": \"\\ud14c\\uc2a4\\ud2b8 \\uba54\\uc2dc\\uc9c0\"}}]}";
        when(httpHandler.get(any())).thenReturn(HttpResponseWrapper.of(200, json));
